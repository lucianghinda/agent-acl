...
### `EXECUTABLE_ALLOWLIST_PATH` <a id="constant-EXECUTABLE_ALLOWLIST_PATH"></a> <a id="EXECUTABLE_ALLOWLIST_PATH-constant"></a>
Not documented.
...
### `UNANALYSABLE_SENTENCE` <a id="constant-UNANALYSABLE_SENTENCE"></a> <a id="UNANALYSABLE_SENTENCE-constant"></a>
Not documented.
